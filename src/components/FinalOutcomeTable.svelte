...
<footer class="bg-white shadow dark:bg-gray-800">
    <div class="flex justify-between w-full mx-auto max-w-screen-xl p-4 md:items-center">
        <div class="text-sm font-medium text-gray-500 dark:text-gray-400">
        </div>
        <div class="text-sm font-medium text-gray-500 dark:text-gray-400">
            © 2023 <a href="https://theodi.org" target="_blank" class="hover:underline">The Open Data Institute</a>.
        </div>
    </div>
</footer>
